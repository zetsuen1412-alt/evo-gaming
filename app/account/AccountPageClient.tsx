    ...
    const loadAccount = async () => {
      ...
      if (accountData) {
        setAccount({
          ...
          national_identity_number:
            accountData.national_identity_number || "",
      ...
      if (billingData) {
        setBilling({
          ...
          tax_identification_number:
            billingData.tax_identification_number || "",
        });
      }
      ...
      <form onSubmit={handleSave}>
        <section className="border-b border-white/10 p-6 md:p-8">
          ...
          <p className="mt-2 max-w-2xl text-sm text-slate-400">
            Manage your personal profile, billing address, tax information, and
            contact details.
          </p>
        </section>

        <section className="border-b border-white/10 p-6 md:p-8">
          <h2 className="text-2xl font-black">Personal</h2>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            ...
            <Field
              ...
              onChange={(value) => updateAccount("first_name", value)}
            />

            <Field
              label="Last Name"
              value={account.last_name}
              onChange={(value) => updateAccount("last_name", value)}
            />
            ...
            <Field
              ...
              onChange={(value) =>
                updateAccount("national_identity_number", value)
              }
            />
            ...
            <Field
              ...
              onChange={(value) => updateAccount("phone_number", value)}
            />
          </div>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            <label className="block">
              ...
              <select
                ...
                onChange={(event) =>
                  updateAccount("instant_messenger_type", event.target.value)
                }
            ...
            <Field
              ...
              onChange={(value) =>
                updateAccount("instant_messenger_value", value)
              }
            />
          </div>
        </section>
        ...
        <section className="border-b border-white/10 p-6 md:p-8">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            <Field
              ...
              onChange={(value) => updateBilling("address_line_1", value)}
            />

            <Field
              label="Address line 2"
              value={billing.address_line_2}
              onChange={(value) => updateBilling("address_line_2", value)}
            />
            ...
            <Field
              ...
              onChange={(value) => updateBilling("country_code", value)}
            />
          </div>
        </section>
        ...
        <section className="p-6 md:p-8">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            <Field
              label="Tax country"
              value={billing.tax_country_code}
              onChange={(value) => updateBilling("tax_country_code", value)}
            />
            ...
            <Field
              ...
              onChange={(value) =>
                updateBilling("tax_identification_number", value)
              }
            />
          </div>
